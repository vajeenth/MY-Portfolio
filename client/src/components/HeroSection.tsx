          ...
          <div className="lg:w-1/2 text-center lg:text-left mb-10 lg:mb-0 animate-slideInLeft">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              ...
              <Button
                onClick={downloadCV}
                variant="outline"
                className="border-2 border-gold text-gold hover:bg-gold hover:text-white hover:border-yellow-500 transition-all duration-300 px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl"
              >
